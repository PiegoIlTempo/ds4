...
# Add debug for metal_graph_output_pre - use (fprintf(...), expr) pattern
old2 = '''                    metal_graph_output_pre(g) && metal_graph_output_weights(g) &&'''
new2 = '''                    (fprintf(stderr, "ds4: DEBUG metal_graph_output_pre\\n"), metal_graph_output_pre(g)) && metal_graph_output_weights(g) &&'''
...
new3 = '''                    (fprintf(stderr, "ds4: DEBUG metal_graph_logits\\n"), metal_graph_logits(g)) && output_tp_ok &&'''
...
new4 = '''                    (fprintf(stderr, "ds4: DEBUG metal_graph_prefill_tokens\\n"), metal_graph_prefill_tokens(g)) &&'''
